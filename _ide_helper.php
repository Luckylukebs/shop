 ...
 * Generated for Laravel 5.4.36 on 2018-10-01 08:51:38.
 *
...
namespace App\QHOnline\Facades { 
    ...
    class Tool {
        ...
        {
            return \App\QHOnline\ToolFactory::getThumbnail($filename, $suffix);
        }
        ...
        {
            return \App\QHOnline\ToolFactory::getCurrencyVN($number, $symbol, $isPrefix);
        }
